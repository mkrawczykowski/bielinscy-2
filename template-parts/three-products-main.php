...
<div class="row">
	<div class="col-sm">
		...
		<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/object2vr/object2vr_player.js">
		</script>
		<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/object2vr/skin.js">
		</script>
		<script type="text/javascript">
			// create the object player with the container
			obj=new object2vrPlayer("product1");
			skin=new object2vrSkin(obj);
			obj.readConfigUrl("<?php echo get_template_directory_uri(); ?>/assets/js/object2vr/settings.xml");
			
			setTimeout(function() { hideUrlBar(); }, 10);
			
			obj2=new object2vrPlayer("product2");
			skin=new object2vrSkin(obj2);
			obj2.readConfigUrl("<?php echo get_template_directory_uri(); ?>/assets/js/object2vr/settings.xml");

			obj3=new object2vrPlayer("product3");
			skin=new object2vrSkin(obj3);
			obj3.readConfigUrl("<?php echo get_template_directory_uri(); ?>/assets/js/object2vr/settings.xml");
		</script>
		<noscript>
