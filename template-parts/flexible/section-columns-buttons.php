...
<div class="container three-products mt-4 pt-4">
	...
	<div class="row">
		<div class="col-sm">
			...
			<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/object2vr/object2vr_player.js">
			</script>
			<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/object2vr/skin.js">
			</script>
			<script type="text/javascript">
				...
				obj2.readConfigUrl("<?php echo get_stylesheet_directory_uri(); ?>/assets/object2vr/settings.xml");

				obj3=new object2vrPlayer("product3");
				skin=new object2vrSkin(obj3);
				obj3.readConfigUrl("<?php echo get_stylesheet_directory_uri(); ?>/assets/object2vr/settings.xml");
			</script>
			<noscript>
